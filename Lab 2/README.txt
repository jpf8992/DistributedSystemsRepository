...
The server was tested and run with all scripts and files stored in the same directory.
...
of the stored directroy to automatically set up the MultiClientServer.rb
...
Type..."start.bat 2000"... into command line of stored directroy
	...
	-> the server should now be awaiting clients and loop forever
